                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" name="dateheurepanne" class="form-control datepicker-time" value="{{old('dateheurepanne') or $today}}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        <div class="input-prepend input-group">
                            <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                            <input type="text" class="form-control datepicker-time" name="dateheuredep" value="{{old('dateheuredep') or $today}}" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="x_content">
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="input-prepend input-group">
                            <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                            <input name="dateexecution" class="date-picker datepicker form-control col-md-7 col-xs-12" required type="text" value="{{$today}}" />
                        </div>
                    </div>
                </div>
            </div>
