    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right alignleft">
                    <h3>Macure <i class="fa fa-leaf"></i></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>{{\Illuminate\Support\Facades\Auth::user()->name()}}<small>Etat d'activité</small></h2>
