...
<head>
    ...
    <title>{{config('app.name','Macure')}} | 404 </title>
        ...
        <div class="col-md-12">
            <div class="col-middle">
                <div class="text-center text-center">
                    ...
                    <h2>Désolé nous n'avons pas trouver la page</h2>
                    <p>La page que vous recherchez est introuvable. Clicquer ici pour <a href="javascript:window.history.back();" style="color: white;">Retourner à la page précédente</a>
                    </p>
