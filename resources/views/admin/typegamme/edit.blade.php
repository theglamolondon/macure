...
@section('content')
    <div class="x_panel">
        <div class="x_title">
            <h3>Nouveau type de gamme</h3>
        </div>
        <div class="x_content">
            <form class="form-horizontal" role="form" method="POST" action="{{route('nouveau_typegamme')}}">
                {{ csrf_field() }}
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="libelle">Titre<span class="required"> *</span></label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="libelle" placeholder="Titre du type de la gamme" required="required" class="form-control"value="{{old('libelle')}}" />
                    </div>
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="reference">Référence<span class="required"> *</span></label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="reference" placeholder="Référence du type de la gamme" required="required" class="form-control"value="{{old('reference')}}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-offset-1 col-sm-offset-1 control-label col-md-1 col-sm-1 col-xs-6" for="indice">Indice</label>
                    <div class="col-md-1 col-sm-1 col-xs-6">
                        <input type="number" name="indice" placeholder="Indice" class="form-control"value="{{old('indice')}}" />
                    </div>
                    ...
                    <div class="col-md-1 col-sm-1 col-xs-6">
                        <input type="number" name="nbreagents" placeholder="Nombre d'agents" class="form-control"value="{{old('nbreagents')}}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="periodicite">Périodicité</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="periodicite" placeholder="Périodicité de la gamme" class="form-control"value="{{old('periodicite')}}" />
                    </div>
                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="habilitation">Habilitation</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <input type="text" name="habilitation" placeholder="Habilitation de la gamme" class="form-control"value="{{old('habilitation')}}" />
                    </div>
                </div>
