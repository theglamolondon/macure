...
@section('content')
    <div class="x_panel">
        <div class="x_title">
            <h4>Ajout d'une ligne de check-list</h4>
            <div class="clearfix"></div>
        </div>
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST" action="{{route('nouveau_checklist')}}">
                    {{csrf_field()}}
                    <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <input type="text" name="libelle" class="form-control" placeholder="Libellé de la check-list" value="{{old('libelle')}}">
                        </div>
                    </div>
